...
function Init()
    ...
    strategy:description("Strategy 842 BestV");
    ...
    strategy.parameters:addInteger("firstSpace", "First Space", "", 8, 0, 50);
    strategy.parameters:addInteger("secondSpace", "Second Space", "", 4, 0, 50);
    --strategy.parameters:addInteger("thirdSpace", "Third Space", "", 2, 0, 50);
    strategy.parameters:addInteger("limitSpace", "Limit Space", "", 16, 1, 50);
    strategy.parameters:addInteger("stopSpace", "Stop Space", "", 16, 1, 50);
